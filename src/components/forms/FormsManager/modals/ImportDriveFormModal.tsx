...
import { MOCK_DRIVE_FORMS } from '../data/mockDriveForms';

interface ImportDriveFormModalProps {
  isImportModalOpen: boolean;
  setIsImportModalOpen: (open: boolean) => void;
  importSearchTerm: string;
  setImportSearchTerm: (value: string) => void;
  isFetchingDriveForms: boolean;
  handleFetchDriveForms: () => void;
  handleImportForm: (mockItem: DriveFormMock) => void;
}

export const ImportDriveFormModal: React.FC<ImportDriveFormModalProps> = ({
  isImportModalOpen,
  setIsImportModalOpen,
  importSearchTerm,
  setImportSearchTerm,
  isFetchingDriveForms,
  handleFetchDriveForms,
  handleImportForm,
}) => {
  return (
    <>
