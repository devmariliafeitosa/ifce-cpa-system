...
import type { FormQuestionInput } from '../../../../services/googleFormsService';

interface CreateCustomFormModalProps {
  isCreateModalOpen: boolean;
  setIsCreateModalOpen: (open: boolean) => void;
  handleCreateCustomForm: (e: React.FormEvent) => void;
  customTitle: string;
...
export const CreateCustomFormModal: React.FC<CreateCustomFormModalProps> = ({
  isCreateModalOpen,
  setIsCreateModalOpen,
  handleCreateCustomForm,
  customTitle,
  setCustomTitle,
  customDescription,
