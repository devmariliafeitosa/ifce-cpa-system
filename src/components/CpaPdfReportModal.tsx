                                ...
                                >
                                    <div>
                                        ...
                                        <div className="flex items-center justify-between mb-6 bg-slate-50 p-4 border border-slate-200 rounded-xl">
                                            ...
                                            <div className="text-right">
                                                <span
                                                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold ${catStatus === 'Sem respostas'
                                            ...
                                            {questions.map((q, qIdx) => (
                                                ...
                                                >
                                                    <div className="flex items-start justify-between gap-3">
                                                        ...
                                                        <span
                                                            className={`text-[10px] px-2.5 py-0.5 rounded-md font-bold whitespace-nowrap ${q.classification === 'Sem respostas' || campaign.totalResponses === 0 || q.totalAnswers === 0
                                                                    ? 'bg-slate-100 text-slate-600 border border-slate-200'
                                                                    ...
                                                                    <div key={aIdx} className="space-y-1 text-[11px]">
                                                                        ...
                                                                        <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                                                                            <div
                                                                                ...
                                                                                className={`h-full rounded-full transition-all ${aIdx === 0
                                                                                        ? 'bg-[#006837]'
                                                                                        : aIdx === 1
                                                                                            ? 'bg-emerald-500'
                                                                                            : aIdx === 2
