    ...
    <div className="w-full max-w-[96%] 2xl:max-w-[1440px] mx-auto px-2 sm:px-4 py-4 space-y-4 select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 space-y-4 flex flex-col">
            ...
            {activeCampaign ? (
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div>
                    <h3 className="text-sm font-bold text-slate-900 hover:text-[#006837] transition-colors cursor-pointer"
                      onClick={() => setSelectedCampaignDetail(activeCampaign)}
                    >
                      {activeCampaign.title}
                    </h3>
                    <p className="text-xs text-slate-500 font-medium mt-0.5">
                      {activeCampaign.campus || 'Campus Tauá'} • {activeCampaign.segmentoTarget || 'Discentes, Docentes e TAEs'}
                    </p>
                  </div>
                  <button
                    onClick={() => setSelectedCampaignDetail(activeCampaign)}
          ...
          <section id="sec-participacao-segmentos" className="bg-white border border-slate-200/90 rounded-xl p-4 shadow-2xs space-y-3 flex-1 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                <div className="flex items-center gap-2">
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
              <span>Universo Total Estimado: <strong className="text-slate-700">~{totalUniverse} participantes</strong></span>
        ...
        <div className="lg:col-span-5 space-y-4 flex flex-col">
          <section id="sec-desempenho-areas" className="bg-white border border-slate-200/90 rounded-xl p-4 shadow-2xs space-y-3 flex-1 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 bg-emerald-100 text-[#006837] rounded-md">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-emerald-100 text-[#006837] rounded-xl">
                    {React.createElement(selectedAreaDetail.icon, { className: 'w-6 h-6' })}
                  </div>
                  <div>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80 space-y-2 text-xs">
                <p className="text-slate-600 font-medium leading-relaxed">
                  {selectedAreaDetail.description || 'Avaliação detalhada dos tópicos da dimensão institucional com base nas percepções de discentes, docentes e técnicos administrativos.'}
                </p>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-medium">
                      {selectedCampaignDetail.campus || 'Campus Tauá'} • Status: {selectedCampaignDetail.status || 'Ativa'}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-50 p-3 rounded-xl border border-slate-200/80">
                  <div>
                    ...
                    <span className="font-bold text-slate-800 block mt-0.5">
                      {selectedCampaignDetail.periodo || '15/09/2026 — 30/09/2026'}
                    </span>
                  </div>
                  <div>
                    ...
                    <span className="font-extrabold text-[#006837] block mt-0.5">
                      {(selectedCampaignDetail.responsesCount?.total || 0).toLocaleString('pt-BR')} respostas
                    </span>
                  </div>
                </div>

                <p className="text-slate-600 text-xs leading-relaxed px-1">
                  {selectedCampaignDetail.description || 'Questionário institucional destinado à coleta de dados e percepções de discentes, docentes e técnicos sobre as condições de ensino, infraestrutura e gestão.'}
                </p>
              </div>
