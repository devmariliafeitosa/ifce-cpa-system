...
} from '../features/forms/utils/campaignStatus';
...
import { RespondFormModal } from '../features/forms/components/RespondFormModal';
import { FormWizardModal } from '../features/forms/components/FormWizardModal';
...
export { IFCE_CAMPUSES_LIST as IFCE_CAMPUSES } from '../features/forms/data/wizardSteps';
export { WIZARD_STEPS } from '../features/forms/data/wizardSteps';
export const FormsManagerView: React.FC<FormsManagerViewProps> = ({
  ...
  const handleParticipantResponseSubmitted = (formId: string, segment: 'alunos' | 'docentes' | 'taes') => {
    setForms((prevForms) =>
      prevForms.map((f) => {
        if (f.id === formId) {
          return {
            ...
            responsesCount: {
              ...
              [segment]: f.responsesCount[segment] + 1,
            },
          };
        }
        return f;
    ...
    setSubmittedCampaignIds((prev) => Array.from(new Set([...prev, formId])));
  };
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-200">
      ...
      */}
      ...
      <RespondFormModal
        form={respondingForm}
        onClose={() => setRespondingForm(null)}
        onSubmitted={handleParticipantResponseSubmitted}
