...
export const INITIAL_SMART_FORMS: SmartForm[] = [
  {
    ...
    title: "Avaliação Institucional Unificada 2025.1 - Campus Tauá",
    description:
  ...
  {
    id: "form-infra-2025",
    title: "Pesquisa de Clima Organizacional e Gestão - Campus Tauá",
    description:
...

  {
    ...
    title: "Pesquisa de Acompanhamento Discente e Egressos",
    description:
