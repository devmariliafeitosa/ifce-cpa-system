...
import { WIZARD_STEPS, IFCE_CAMPUSES_LIST as IFCE_CAMPUSES } from '../data/wizardSteps';

/* Wizard de criação de formulário em 6 etapas (Informações, Perguntas, Segmentos,
 * Perguntas por segmento, Revisão, Envio). Extraído de FormsManagerView.tsx.
 * Todo o estado deste fluxo ainda pertence ao container (FormsManagerView) e é
 * repassado via props, pois é compartilhado com outros fluxos (importação/classificação
 * de perguntas, edição de formulário, envio de e-mail). */
...
interface FormWizardModalProps {
  ...
  handleAddSegmentQuestion: (seg: 'alunos' | 'docentes' | 'taes') => void;
  selectedSegment: 'alunos' | 'docentes' | 'taes';
  setSelectedSegment: (seg: 'alunos' | 'docentes' | 'taes') => void;
  completedSegments: string[];
  setCompletedSegments: React.Dispatch<React.SetStateAction<string[]>>;
  ...
  sendMethods: { email: boolean; qrcode: boolean; link: boolean };
  setSendMethods: React.Dispatch<React.SetStateAction<{ email: boolean; qrcode: boolean; link: boolean }>>;
  emailSubject: string;
  setShowEmailPreviewModal: (value: boolean) => void;
  setShowEmailEditModal: (value: boolean) => void;
  setIsPreviewQuestionsModalOpen: (value: boolean) => void;
  wizardCopiedLink: boolean;
  setWizardCopiedLink: (value: boolean) => void;
  setShowQrCodePreviewModal: (value: boolean) => void;
  setShowSendConfirmModal: (value: boolean) => void;
