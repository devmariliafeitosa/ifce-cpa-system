...
/* Confirmação final antes de disparar o envio de uma campanha. Extraído de FormsManagerView.tsx. */
...
export const SendConfirmDialog: React.FC<SendConfirmDialogProps> = ({ isOpen, onClose, onConfirm }) => {
