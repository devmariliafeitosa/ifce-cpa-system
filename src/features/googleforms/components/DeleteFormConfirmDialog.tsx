...
import { GoogleFormFile } from '../../../services/googleFormsService';

/* Confirmação de exclusão de Google Form (ação destrutiva). Extraído de
 * GoogleFormsManager.tsx. */
...
export const DeleteFormConfirmDialog: React.FC<DeleteFormConfirmDialogProps> = ({
  deleteTarget,
  isDeleting,
  onCancel,
  onConfirm,
