...
import { BarChart2, X, Loader2, ExternalLink } from 'lucide-react';
import { GoogleFormDetails, GoogleFormResponsesData } from '../../../services/googleFormsService';

/* Modal de inspeção de um Google Form: metadados, links diretos, lista de perguntas
 * e preview embutido. Extraído de GoogleFormsManager.tsx. */
